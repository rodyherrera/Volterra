...
protected:
	...
	void createAdjacentQuad(BaseAtom* center, MeshNode* vertex1, MeshNode* vertex2, const Vector3& edgeVector1, const Vector3& edgeVector2);
	void closeFacetHoles();
	void createFacetAndEdges(int numVertices, MeshNode** vertices, const Vector3* edgeVectors);
	...
	bool constructFacetRecursive(int numEdges, int maxEdges, MeshNode** vertices, MeshEdge** edges, const Vector3& burgersVector);
	bool edgeEdgeOrientation(MeshEdge* edge1, MeshEdge* edge2);
	bool createAdjacentTriangle(MeshNode* center, MeshNode* vertex1, BaseAtom* vertex2, const Vector3& edgeVector1, const Vector3& edgeVector2);
