...
import CanvasSidebarModifiers from '@/features/canvas/components/molecules/CanvasSidebarModifiers';
import CanvasSidebarScene from '@/features/canvas/components/molecules/CanvasSidebarScene';
...
import LightsControls from '@/features/canvas/components/molecules/LightsControls';
import EffectsControls from '@/features/canvas/components/molecules/EffectsControls';
import PerformanceSettingsControls from '@/features/canvas/components/molecules/PerfomanceSettingsControls';
import EnvironmentControls from '@/features/canvas/components/molecules/EnvironmentControls';
import CameraSettingsControls from '@/features/canvas/components/molecules/CameraSettingsControls';
import RendererSettingsControls from '@/features/canvas/components/molecules/RendererSettingsControls';
import CanvasGridControls from '@/features/canvas/components/molecules/CanvasGridControls';
import OrbitControls from '@/features/canvas/components/molecules/OrbitControls';
import Container from '@/components/primitives/Container';
import '@/features/canvas/components/organisms/EditorSidebar/EditorSidebar.css';
