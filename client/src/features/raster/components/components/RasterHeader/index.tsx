...
import RasterTrajectoryDetailsSkeleton from '@/features/raster/components/atoms/RasterTrajectoryDetailsSkeleton';
import RasterSceneViewsSkeleton from '@/features/raster/components/atoms/RasterSceneViewsSkeleton';
