...
export const createChatUISlice: SliceCreator<ChatUISlice, any> = (set) => ({
    ...initialUIState,
    ...
    toggleMemberSelection: (id) => set((s: any) => ({ selectedMembers: s.selectedMembers.includes(id) ? s.selectedMembers.filter((x: string) => x !== id) : [...s.selectedMembers, id] })),
    toggleAdminSelection: (id) => set((s: any) => ({ selectedAdmins: s.selectedAdmins.includes(id) ? s.selectedAdmins.filter((x: string) => x !== id) : [...s.selectedAdmins, id] })),
