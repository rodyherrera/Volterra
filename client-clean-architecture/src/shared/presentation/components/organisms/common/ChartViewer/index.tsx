...
import { decodeMsgpackBuffer } from '@/shared/utilities/api/msgpack';
import Loader from '@/shared/presentation/components/atoms/common/Loader';
import WindowIcons from '@/shared/presentation/components/molecules/common/WindowIcons';
...
const ChartViewer: React.FC<ChartViewerProps> = ({
    ...
    useEffect(() => {
        ...
        const fetchData = async() => {
            ...
            setError(null);
            try{
                const response = await pluginRepository.getFile(
                    trajectoryId,
                    analysisId,
                    exposureId,
                    timestep,
