...
import { formatNetworkSpeedWithUnit } from '@/shared/utilities/common/network';
...
import '@/shared/presentation/components/molecules/common/MetricsCards/MetricsCards.css';
