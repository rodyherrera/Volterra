...
import useDraggable, { type DraggableOptions, type DraggableHandle } from '@/shared/presentation/hooks/ui/drag-drop/use-draggable';
import '@/shared/presentation/components/atoms/common/Draggable/Draggable.css';
