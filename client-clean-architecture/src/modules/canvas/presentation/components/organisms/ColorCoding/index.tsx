...
const ColorCoding = () => {
    const { applyColorCodingUseCase, getColorCodingStatsUseCase } = getRasterUseCases();
    const {
        property,
        exposureId,
        propertyOptions,
    ...
    const applyColorCoding = async () => {
        try {
            await applyColorCodingUseCase.execute(trajectory!._id, analysisConfig?._id, currentTimestep!, {
    ...
    const fetchStats = async () => {
        ...
        try {
            const stats = await getColorCodingStatsUseCase.execute(trajectory._id, analysisConfig?._id, {
