...
import ThumbnailSkeleton from '@/modules/raster/presentation/components/atoms/ThumbnailSkeleton';
import ThumbnailItem from '@/modules/raster/presentation/components/atoms/ThumbnailItem';
