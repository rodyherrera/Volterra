...
import { usePluginBuilderStore } from '../../../../stores/builder-slice';
...
const EntrypointEditor: React.FC<EntrypointEditorProps> = ({ node }) => {
    ...
    const handleRemoveBinary = useCallback(async () => {
        ...
        try {
            await pluginRepository.deleteBinary(currentPlugin._id);
            updateData({
                binary: '',
    ...
    }, [currentPlugin?._id, entrypoint.binaryObjectPath, updateData, confirm]);
