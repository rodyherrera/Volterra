...
import FileUpload from '@/shared/presentation/components/molecules/common/FileUpload';
...
import { formatNumber } from '@/shared/presentation/components/organisms/common/DocumentListing';
...
import '@/modules/dashboard/presentation/pages/Dashboard/Dashboard.css';

const DashboardPage: React.FC = memo(() => {
    usePageTitle('Dashboard');

    const selectedTeam = useTeamStore((state) => state.selectedTeam);
    const { trajectories, isLoading: isLoadingTrajectories } = useTrajectories();
            ...
            <DashboardContainer className='d-flex h-max sm:column w-max gap-2 p-1   '>
                ...
                <Container className='d-flex column dashboard-body-right-container gap-2'>
                    <Container className='dashboard-stats-wrapper p-relative w-max'>
                        <DashboardStats teamId={selectedTeam?._id} trajectoryId={firstTrajectoryId} />
                    </Container>
