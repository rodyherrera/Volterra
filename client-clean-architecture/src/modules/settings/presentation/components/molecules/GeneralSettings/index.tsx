...
import RecentActivity from '@/modules/auth/presentation/components/molecules/RecentActivity';
import { TbCheck, TbTrash, TbX, TbActivity, TbCamera } from 'react-icons/tb';
import { getAuthUseCases } from '@/modules/auth/application/registry';
...
import '@/modules/settings/presentation/components/molecules/GeneralSettings/GeneralSettings.css';
...
const GeneralSettings: React.FC<GeneralSettingsProps> = ({
    ...
    const { updateMeUseCase } = getAuthUseCases();
    ...
    const handleAvatarUpload = async(e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try{
            ...
            await updateMeUseCase.execute(fd);
