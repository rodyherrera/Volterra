...
import GeneralSettings from '@/modules/settings/presentation/components/molecules/GeneralSettings';
...
const GeneralPage: React.FC = () => {
    ...
    }, [user, updateMeUseCase]);

    const updateUserOnServer = useCallback(async (field: string, value: string) => {
        try {
            setIsUpdating(true);
            setUpdateError(null);
            await updateMeUseCase.execute({ [field]: value } as any);
