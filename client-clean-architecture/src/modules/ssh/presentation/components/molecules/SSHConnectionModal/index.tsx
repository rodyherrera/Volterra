...
import { TbCheck, TbX as TbXIcon } from 'react-icons/tb';
...
const SSHConnectionModal: React.FC<SSHConnectionModalProps> = ({
    ...
    const { createConnection, updateConnection, testConnection } = useSSHStore();
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="d-flex column gap-1 ssh-connection-modal-form overflow-hidden">
                ...
                <Container className="d-flex content-end gap-075 ssh-connection-modal-footer p-1-5">
                    <Button
                        variant="outline"
                        intent="neutral"
