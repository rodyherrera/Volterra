...
import SSHConnectionModal from '../../../components/molecules/SSHConnectionModal';
...
const SSHConnectionsListing = () => {
    ...
    const { connections, loading, fetchConnections, deleteConnection, testConnection } = useSSHStore();
