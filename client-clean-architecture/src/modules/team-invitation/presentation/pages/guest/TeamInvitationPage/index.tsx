...
import '@/modules/auth/presentation/pages/guest/SignIn/SignIn.css';
import '@/modules/team-invitation/presentation/pages/guest/TeamInvitationPage/TeamInvitationPage.css';
...
const TeamInvitationPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchInvitation = async () => {
            try {
                const details = await teamInvitationRepository.getDetails(token!);
    ...
    const handleAccept = async () => {
        ...
        try {
            await teamInvitationRepository.accept(token);
            setError(null);
            setTimeout(() => {
    ...
    const handleReject = async () => {
        ...
        setActionLoading(true);
        try {
            await teamInvitationRepository.reject(token);
            setError(null);
            setTimeout(() => {
                navigate('/dashboard');
            }, 2000);
