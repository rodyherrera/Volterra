...
import '@/modules/container/presentation/components/organisms/CreateContainerModal/CreateContainerModal.css';
...
const CreateContainerModal: React.FC<CreateContainerModalProps> = ({ isOpen, onSuccess }) => {
    ...
    const { createContainerUseCase } = getContainerUseCases();

    useEffect(() => {
        if (isOpen) {
            getUserTeamsUseCase.execute().then(teamsList => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await createContainerUseCase.execute({
                name,
                image,
                team: teamId,
