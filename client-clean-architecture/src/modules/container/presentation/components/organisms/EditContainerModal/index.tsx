...
import '@/modules/container/presentation/components/organisms/EditContainerModal/EditContainerModal.css';
...
const EditContainerModal: React.FC<EditContainerModalProps> = ({ container, onSuccess }) => {
    ...
    const { updateContainerUseCase } = getContainerUseCases();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            await updateContainerUseCase.execute(container._id, {
