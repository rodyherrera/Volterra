...
import { getTeamUseCases } from '@/modules/team/application/registry';
...
import '@/modules/container/presentation/pages/protected/CreateContainer/CreateContainer.css';
...
const CreateContainer: React.FC = () => {
    ...
    const { createContainerUseCase, getSystemStatsUseCase } = getContainerUseCases();
    const { getUserTeamsUseCase } = getTeamUseCases();
    ...
    useEffect(() => {
        ...
        const fetchTeams = async () => {
            try {
                const teamsList = await getUserTeamsUseCase.execute();
                setTeams(teamsList);
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            await createContainerUseCase.execute(payload);
