...
import ChatListSkeleton from '@/modules/chat/presentation/components/atoms/messages/ChatListSkeleton';
...
import '@/modules/chat/presentation/components/molecules/ChatSidebar/ChatSidebar.css';
                                    ...
                                    <div className='d-flex items-center content-between chat-conversation-header'>
                                        ...
                                        {(chat.lastMessage || chat.updatedAt) && (
                                            <span className='chat-conversation-time font-weight-5 color-muted'>
                                                {formatDistanceToNow(chat.lastMessage?.createdAt || chat.updatedAt, { addSuffix: true })}
                                            </span>
                                        )}
                                    </div>
                                    {chat.lastMessage && (
