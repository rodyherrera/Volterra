...
import TextMessage from '@/modules/chat/presentation/components/atoms/TextMessage';
import FileMessage from '@/modules/chat/presentation/components/atoms/FileMessage';
import MessageControls from '@/modules/chat/presentation/components/atoms/MessageControls';
import ReactionsBar from '@/modules/chat/presentation/components/atoms/ReactionsBar';
...
import '@/modules/chat/presentation/components/molecules/MessageItem/MessageItem.css';
        ...
        <div className={`d-flex chat-message ${isOwn ? 'sent' : 'received'} ${isDeleted ? 'deleted' : ''} ${showAvatar ? 'with-avatar' : ''} p-relative`}>
            ...
            <div className='d-flex column chat-message-wrapper w-max'>
                ...
                <div className='chat-message-content p-relative'>
                    ...
                    <div className='d-flex items-center gap-05 chat-message-time font-size-1 color-muted'>{formatDistanceToNow(msg.createdAt, { addSuffix: true })}</div>
                </div>
            </div>
        </div>
    )
