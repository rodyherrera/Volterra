...
import { useChat } from '@/modules/chat/presentation/hooks/use-chat';
...
import useAutoScroll from '@/shared/presentation/hooks/ui/use-auto-scroll';
import useToggleId from '@/shared/presentation/hooks/ui/use-toggle-id';
import MessageItem from '@/modules/chat/presentation/components/molecules/MessageItem';
import TypingIndicator from '@/modules/chat/presentation/components/atoms/TypingIndicator';
import ChatInput from '@/modules/chat/presentation/components/organisms/ChatInput';
import WelcomeEmpty from '@/modules/chat/presentation/components/atoms/WelcomeEmpty';
import DetailsPanel from '@/modules/chat/presentation/components/molecules/DetailsPanel';
import ChatHeader from '@/modules/chat/presentation/components/molecules/ChatHeader';
import MessageList from '@/modules/chat/presentation/components/molecules/MessageLists';
import useConfirm from '@/shared/presentation/hooks/ui/use-confirm';
import '@/modules/chat/presentation/components/organisms/ChatArea/ChatArea.css';
