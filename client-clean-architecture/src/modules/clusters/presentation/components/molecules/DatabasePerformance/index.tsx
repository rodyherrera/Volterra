...
import '@/modules/clusters/presentation/components/molecules/DatabasePerformance/DatabasePerformance.css'
  ...
  if (active && payload && payload.length >= 3) {
    return (
      <div className="db-tooltip">
        <Paragraph className="db-tooltip-label font-size-2 font-weight-6 font-weight-5 color-primary">{payload[0].payload.time}</Paragraph>
        <Paragraph className="db-tooltip-item font-size-1 color-secondary" style={{ color: '#3b82f6' }}>
          Queries: {payload[0].value}
        </Paragraph>
        <Paragraph className="db-tooltip-item font-size-1 color-secondary" style={{ color: '#8b5cf6' }}>
          Connections: {payload[1].value}
        </Paragraph>
        <Paragraph className="db-tooltip-item font-size-1 color-secondary" style={{ color: '#06b6d4' }}>
